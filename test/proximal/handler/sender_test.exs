defmodule Proximal.Handler.SenderTest do
  use ExUnit.Case, async: false

  alias Proximal.Stream, as: XmlStream
  ...
  describe "process a document" do
    test "correctly step by step (debug)" do
      Application.put_env(:proximal, :debug_xml, true)
    ...
    test "correctly step by step" do
      Application.put_env(:proximal, :debug_xml, false)
